...
let arr = [
  ...
  [51.4987, -0.084],
  [51.4985, -0.083],
]; //[31.3260,75.5762],[30.9010,75.8573]];
let i = 0,
  pgid;
let lati = arr[0][0],
  longi = arr[0][1],
  key = 0;
let coords = { lati: 0, long: 0, key: 0 },
  setCoords;
async function update() {
  ...
  await sleep(1000);
  Axios.get("http://localhost:5000/getLiveLocation?key=" + pgid).then(
    (response) => {
    ...
    <>
      <section className="view-pg-intro p-3">
        <div className="container">
          <div className="row">
            <div className="col">
              <p className="h2 text-dark"> Asset Details</p>
          ...
          if (key == pgid) {
            return (
              ...
              <section key={key} className="view-pg mt-3">
                <div className="container">
                  <div className="row">
                    <div className="col-md-12" style={{height: "400px", width: "100%", marginBottom: '5%'}}>
                    ...
                    <div className="col-md-7">
                      <ul className="list-group">
                        <li className="list-group-item list-group-item-action fw-bold" style={{border: "1px solid purple"}}>
                          {" "}
                          Name :
